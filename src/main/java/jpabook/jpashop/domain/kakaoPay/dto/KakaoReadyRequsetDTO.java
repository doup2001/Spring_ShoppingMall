...
//    String failUrl;
    ...
    public MultiValueMap<String, Object> getParametersMap() {
        ...
        parameters.add("approval_url", "http://eedo.shop:8080/order/success"); // 성공 시 redirect url
        parameters.add("cancel_url", "http://eedo.shop:8080/order/cancel"); // 취소 시 redirect url
        parameters.add("fail_url", "http://eedo.shop:8080/order/fail"); // 실패 시 redirect url
